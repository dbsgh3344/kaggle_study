...
def df_counting(p0_data,p1_data,x_data,variable_name):
    ...
    p0_df['P0_'+variable_name] = p0_data.game_id.value_counts().values
    p1_df['P1_'+variable_name] = p1_data.game_id.value_counts().values
    ...
    x_data['P0_'+variable_name] = df['P0_'+variable_name]
    x_data['P1_'+variable_name] = df['P1_'+variable_name]
    x_data['delta_'+variable_name] = x_data['P0_'+variable_name] - x_data['P1_'+variable_name]
